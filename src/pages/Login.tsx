      ...
      <div className="bg-white p-8 rounded-[32px] shadow-sm border border-[#0C2B4E]/5 w-full max-w-sm flex flex-col items-center relative z-10">
        ...
        <div className="w-full flex flex-col gap-3">
          ...
          <button 
            ...
            className="w-full bg-[#F4F1EE] hover:bg-[#e8e4e1] text-[#0C2B4E] border border-[#0C2B4E]/10 py-4 rounded-xl flex items-center justify-center gap-3 transition-colors font-bold tracking-wide"
          >
            Login as Guest
          </button>
        </div>
